...
<body>
  ...
  <main>
    <section id="2511530016">
      <h2>Selamat Datang</h2>
      <?php
      echo "halo dunia!<br>";
      echo "nama saya radin";
      ?>
    ...
    $fieldConfig = [
      ...
      "nama" => ["label" => "Radin:", "suffix" => " &#128526;"],
      "tempat" => ["label" => "Belinyu:", "suffix" => ""],
      "tanggal" => ["label" => "20 Maret 2006:", "suffix" => ""],
      "hobi" => ["label" => "Mancing dan Futsal:", "suffix" => " &#127926;"],
      "pasangan" => ["label" => "single:", "suffix" => " &hearts;"],
      "pekerjaan" => ["label" => "Barista:", "suffix" => " &copy; 2025"],
      "ortu" => ["label" => "Dullhasim dan Asmara Murni:", "suffix" => ""],
      "kakak" => ["label" => "M Zatul Abbas:", "suffix" => ""],
      "adik" => ["label" => "Ariyanto:", "suffix" => ""],
    ];
    ?>
    ...
    <section id="contact">
      ...
      <form action="proses.php" method="POST">
        ...
        <label for="txtNama"><span>Radin:</span>
          <input type="text" id="txtNama" name="txtNama" placeholder="Masukkan nama"
            required autocomplete="name"
            value="<?= isset($old['nama']) ? htmlspecialchars($old['nama']) : '' ?>">
        </label>

        <label for="txtEmail"><span>Radinsardin321gmail.com:</span>
  ...
  <footer>
    <p>&copy; 2025 Radin [2511530016]</p>
  </footer>
